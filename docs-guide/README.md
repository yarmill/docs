...
> **New here? Read [`how-to-generate-docs.md`](how-to-generate-docs.md)** — a plain-language
> guide to asking Claude Code for any kind of docs content. No codebase knowledge needed.
