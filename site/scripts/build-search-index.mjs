...
// Output: public/search-index.json — an array of { id, url, title, group, headings, text }.
//
// Emitted to public/ (not lib/) so it ships as a static asset and is fetched
// lazily by the search palette on first open, instead of being bundled into the
// initial client JS. It's gitignored — regenerated by `prebuild` (and safe to
// run ad-hoc: node scripts/build-search-index.mjs).
